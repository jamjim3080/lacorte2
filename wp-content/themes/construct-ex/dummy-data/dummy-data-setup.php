 ...
 * Set import files
 */
function construct_set_import_files() {
    return array(
        array(
            'import_file_name'           => __('Dummy-data', 'construct-ex'),
            'local_import_file'          => trailingslashit( get_template_directory() ) . 'dummy-data/dummy-data.xml',
        ),
    );
}
add_filter( 'pt-ocdi/import_files', 'construct_set_import_files' );

/**
 * Define actions that happen after import
 */
function construct_actions_after_import() {
...
add_action( 'pt-ocdi/after_import', 'construct_actions_after_import' );
