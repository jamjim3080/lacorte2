...
function construct_customize_register( $wp_customize ) {
	...
	//$wp_customize->get_section( 'header_image' )->panel = 'construct_header_panel';
	...
	$wp_customize->add_panel( 'header_top_panel', array(
		'title' => __( 'Header Top Section', 'construct-ex' ),
		'description' => __( 'Change the font size and color for Site Title, Site Tagline and Menu', 'construct-ex' ), // Include html tags such as <p>.
		'priority' => 1, // Mixed with top-level-section hierarchy.
		) );
		
		//Site Title section
		$wp_customize->add_section( 'site_title_section', array(
			'title' => __( 'Site Title' , 'construct-ex' ),
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'site_title_color', array(
					...
					'label' => __( 'Color', 'construct-ex' ),
					'description' => __( 'Change color of site title', 'construct-ex' ),
					) )
				);
		
		//Site Tagline section
		$wp_customize->add_section( 'site_tagline_section', array(
			'title' => __( 'Site Tagline' , 'construct-ex' ),
			'panel' => 'header_top_panel',
			'priority' => 2,
			'capability' => 'edit_theme_options',
			) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'tagline_color', array(
					...
					'label' => __( 'Color', 'construct-ex' ),
					'description' => __( 'Change color of site tagline', 'construct-ex' ),
					) ) );
			
	/*--- Header Banner ---*/
	$wp_customize->add_panel( 'header_banner', array(
		'title' => __( 'Header Banner', 'construct-ex' ),
		'description' => __( 'Change the font size and color for Site Title, Site Tagline and Menu', 'construct-ex' ),
		'priority' => 2,
		) );
	
		//Banner type section
		$wp_customize->add_section( 'banner_type_section', array(
			'title' => __( 'Banner Type' , 'construct-ex' ),
			'panel' => 'header_banner',
			'priority' => 1,
			'capability' => 'edit_theme_options',
			) );
			...
			$wp_customize->add_control( 'banner_type', array(
				...
				'label' => __( 'Fron page banner type', 'construct-ex' ),
				'description' => __( 'Select banner type for front page', 'construct-ex' ),
				'choices' => array(
					'bg-color' => __( 'Background Color', 'construct-ex' ),
					'bg-gradient' => __( 'Background Gradient', 'construct-ex' ),
					'image' => __( 'Background Image', 'construct-ex' ),
					'video' => __( 'Background Video', 'construct-ex' ),
				),
				) );
			...
			$wp_customize->add_control( 'banner_height', array(
				...
				'label' => __( 'Height of banner (Default: 700px)', 'construct-ex' ),
				'input_attrs' => array(
					'min' => 0,
					'max' => 2000,
					'step' => 1,
		...
		$wp_customize->add_section( 'banner_bg_color_section', array(
			'title' => __( 'Banner Background: Color' , 'construct-ex' ),
			'panel' => 'header_banner',
			'priority' => 2,
			'capability' => 'edit_theme_options',
			) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'banner_bg_color', array(
					...
					'label' => __( 'Background Color', 'construct-ex' ),
					'description' => __( 'Change background color of banner', 'construct-ex' ),
				) ) );
			
		//Banner background Gradient section
		$wp_customize->add_section( 'banner_bg_gradient_section', array(
			'title' => __( 'Banner Background: Gradient' , 'construct-ex' ),
			'panel' => 'header_banner',
			'priority' => 3,
			'capability' => 'edit_theme_options',
			'description' => __( 'Choose the colors below to give gradient background to your banner', 'construct-ex' ),
			) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'banner_bg_gradient_1', array(
					...
					'label' => __( 'Gradient color 1', 'construct-ex' ),
					'description' => __( 'Add 1st Gradient color', 'construct-ex' ),
					) ) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'banner_bg_gradient_2', array(
					...
					'label' => __( 'Gradient color 2', 'construct-ex' ),
					'description' => __( 'Add 2nd Gradient color', 'construct-ex' ),
					) ) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'banner_bg_gradient_3', array(
					...
					'label' => __( 'Gradient color 3', 'construct-ex' ),
					'description' => __( 'Add 3rd Gradient color', 'construct-ex' ),
					) ) );
		
		//Banner background image section
		$wp_customize->add_section( 'banner_bg_img_section', array(
			'title' => __( 'Banner Background: Image' , 'construct-ex' ),
			'panel' => 'header_banner',
			'priority' => 4,
			'capability' => 'edit_theme_options',
			'description' => __( 'Upload image and set other settings for banner background', 'construct-ex' ),
			) );
			...
			$wp_customize->add_control( new WP_Customize_Image_Control(
				$wp_customize, 'banner_bg_img', array(
					...
					'label' => __( 'Upload image for background', 'construct-ex' ),
					) ) );
			...
			$wp_customize->add_control( 'banner_bg_size', array(
				...
				'label' => __( 'Banner background size', 'construct-ex' ),
				'choices' => array(
					'cover' => __( 'cover', 'construct-ex' ),
					'contain' => __( 'contain', 'construct-ex' ),
				),
				) );
			...
			$wp_customize->add_control( 'banner_bg_pos', array(
				...
				'label' => __( 'Banner background position', 'construct-ex' ),
				'choices' => array(
					'top-left' => __( 'top left', 'construct-ex' ),
					'top-center' => __( 'top center', 'construct-ex' ),
					'top-right' => __( 'top right', 'construct-ex' ),
					'center-left' => __( 'center left', 'construct-ex' ),
					'center-center' => __( 'center center', 'construct-ex' ),
					'center-right' => __( 'center right', 'construct-ex' ),
					'bottom-left' => __( 'bottom left', 'construct-ex' ),
					'bottom-center' => __( 'bottom center', 'construct-ex' ),
					'bottom-right' => __( 'bottom right', 'construct-ex' ),
				),
				) );
			...
			$wp_customize->add_control( 'banner_bg_repeat', array(
				...
				'label' => __( 'Banner background no-repeat', 'construct-ex' ),
				) );
			
		//Banner content section
		$wp_customize->add_section( 'banner_content_section', array(
			'title' => __( 'Banner content' , 'construct-ex' ),
			'panel' => 'header_banner',
			'priority' => 5,
			'capability' => 'edit_theme_options',
			'description' => __( 'Form here you can change the text of all titles, subititle and paragraph present on banner', 'construct-ex' ),
			) );
		
			//Banner main title
			$wp_customize->add_setting( 'banner_main_title', array(
				'capability' => 'edit_theme_options',
				'default' => __( 'SUPERIOR QUALITY AND RESULTS', 'construct-ex' ),
				'transport' => 'refresh',
			...
			$wp_customize->add_control( 'banner_main_title', array(
				...
				'label' => __( 'Banner main title', 'construct-ex' ),
				) );
			
			//Banner sub title
			$wp_customize->add_setting( 'banner_sub_title', array(
				'capability' => 'edit_theme_options',
				'default' => __( 'COMMITTED TO', 'construct-ex' ),
				'transport' => 'refresh',
				'sanitize_callback' => 'wp_filter_nohtml_kses',
				) );
			...
			$wp_customize->add_control( 'banner_sub_title', array(
				...
				'label' => __( 'Banner sub title', 'construct-ex' ),
				) );
			
			//Banner paragraph
			$wp_customize->add_setting( 'banner_para', array(
				'capability' => 'edit_theme_options',
				'default' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi imperdiet ullamcorper erat', 'construct-ex' ),
				'transport' => 'refresh',
				'sanitize_callback' => 'wp_filter_nohtml_kses',
				) );
			...
			$wp_customize->add_control( 'banner_para', array(
				...
				'label' => __( 'Banner paragraph', 'construct-ex' ),
				) );
			
			//Banner button1 text
			$wp_customize->add_setting( 'banner_btn1_txt', array(
				'capability' => 'edit_theme_options',
				'default' => __( 'Get Started', 'construct-ex' ),
				'transport' => 'refresh',
				'sanitize_callback' => 'wp_filter_nohtml_kses',
				) );
			...
			$wp_customize->add_control( 'banner_btn1_txt', array(
				...
				'label' => __( 'Banner 1st button text', 'construct-ex' ),
				) );
			
			//Banner button1 url
			$wp_customize->add_setting( 'banner_btn1_url', array(
				'capability' => 'edit_theme_options',
				'default' => __( '#', 'construct-ex' ),
				'transport' => 'refresh',
				'sanitize_callback' => 'wp_filter_nohtml_kses',
				) );
			...
			$wp_customize->add_control( 'banner_btn1_url', array(
				...
				'label' => __( 'Banner 1st button url', 'construct-ex' ),
				) );
			
			//Banner button2 text
			$wp_customize->add_setting( 'banner_btn2_txt', array(
				'capability' => 'edit_theme_options',
				'default' => __( 'Know More', 'construct-ex' ),
				'transport' => 'refresh',
				'sanitize_callback' => 'wp_filter_nohtml_kses',
				) );
			...
			$wp_customize->add_control( 'banner_btn2_txt', array(
				...
				'label' => __( 'Banner 2nd button text', 'construct-ex' ),
				) );
			...
			$wp_customize->add_control( 'banner_btn2_url', array(
				...
				'label' => __( 'Banner 2nd button url', 'construct-ex' ),
				) );
			...
			$wp_customize->add_control( new WP_Customize_Image_Control(
				$wp_customize, 'banner_side_img', array(
					...
					'label' => __( 'Upload side image for banner', 'construct-ex' ),
					) ) );
				
	
	/*--- General settings ---*/
	$wp_customize->add_panel( 'general_settings', array(
		'title' => __( 'General settings', 'construct-ex' ),
		'priority' => 3,
		) );
		
		//Page padding section
		$wp_customize->add_section( 'page_padding', array(
			'title' => __( 'Main page padding' , 'construct-ex' ),
			'panel' => 'general_settings',
			'priority' => 1,
			'capability' => 'edit_theme_options',
			'description' => __( 'Form here you can change the top and bottom padding of page', 'construct-ex' ),
			) );
			...
			$wp_customize->add_control( 'page_top_padding', array(
				...
				'label' => __( 'Space between header and page content (in px)', 'construct-ex' ),
				'input_attrs' => array(
					'min' => 0,
					'max' => 500,
					'step' => 1,
			...
			$wp_customize->add_control( 'page_bottom_padding', array(
				...
				'label' => __( 'Space between footer and page content (in px)', 'construct-ex' ),
				'input_attrs' => array(
					'min' => 0,
					'max' => 500,
					'step' => 1,
	...
	$wp_customize->add_panel( 'theme_blog_panel', array(
		'title' => __( 'Blogs Panel', 'construct-ex' ),
		'priority' => 4,
		) );
		
		//Blog layout
		$wp_customize->add_section( 'theme_blog_layout', array(
			'title' => __( 'Blog layout' , 'construct-ex' ),
			...
			$wp_customize->add_control( 'theme_blog_type', array(
				...
				'label' => __( 'Select blog layout', 'construct-ex' ),
				'description' => __( 'This will change the styling of blogs on blog and single blog page', 'construct-ex' ),
				'choices' => array(
					'default' => __( 'Default', 'construct-ex' ),
			...
			$wp_customize->add_control( 'show_sidebar', array(
				...
				'label' => __( 'Check this box to show sidebar on blogs page', 'construct-ex' ),
				) );
			...
			$wp_customize->add_control( 'show_sidebar_single', array(
				...
				'label' => __( 'Check this box to show sidebar on single blog page', 'construct-ex' ),
				) );
	...
	/*--- Colors panel ---*/		
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'primary_color', array(
					...
					'label' => __( 'Primary color', 'construct-ex' ),
					'description' => __( 'Change in this color will change the primary color of whole theme', 'construct-ex' ),
					) ) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'theme_text_color', array(
					...
					'label' => __( 'Theme text color', 'construct-ex' ),
					'description' => __( 'Change in this color will change the text color of whole theme (basically all paragraphs).', 'construct-ex' ),
					) ) );
}
...
function twx_sntz_banner_type( $value ){
	$valid = array(
        'bg-color' => __( 'Color', 'construct-ex' ),
		'bg-gradient' => __( 'Gradient', 'construct-ex' ),
		'image' => __( 'Image', 'construct-ex' ),
		'video' => __( 'Video', 'construct-ex' ),
		'carousel' => __( 'Background Carousel', 'construct-ex' ),
	);
	return ( array_key_exists( $value, $valid ) ? $value : '' );
}

function construct_sanitize_menu( $value ){
	$valid = array(
		'sticky'   => __('Sticky', 'construct-ex'),
		'static'   => __('Static', 'construct-ex'),
	);
	return ( array_key_exists( $value, $valid ) ? $value : '' );
}
...
function twx_sntz_blog_type( $value ){
	$valid = array(
		'default'           => __( 'Default', 'construct-ex' ),
		'special'       => __( 'Special', 'construct-ex' )
	);
	return ( array_key_exists( $value, $valid ) ? $value : '' );
}
...
function construct_sanitize_widget_area($value){
	$valid = array(
		'1'     => __('One', 'construct-ex'),
		'2'     => __('Two', 'construct-ex'),
		'3'     => __('Three', 'construct-ex'),
		'4'     => __('Four', 'construct-ex')
	);
	return ( array_key_exists( $value, $valid ) ? $value : '' );
}

function construct_sanitize_wc_content($value){
	$valid = array(
		'left'    => __('Left', 'construct-ex'),
		'right'     => __('Right', 'construct-ex'),
	);
	return ( array_key_exists( $value, $valid ) ? $value : '' );
}

function construct_sanitize_image( $input ){
