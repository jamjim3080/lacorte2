...
function construct_banner_background() {
	
	$title = get_theme_mod('banner_sub_title', __('COMMITTED TO', 'construct-ex'));
	$fornt_img = get_theme_mod('banner_side_img','');
	$subtitle = get_theme_mod('banner_main_title', __('SUPERIOR QUALITY AND RESULTS', 'construct-ex'));
	$subpera = get_theme_mod('banner_para', __('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi imperdiet ullamcorper erat', 'construct-ex'));
	$button_text1 = get_theme_mod('banner_btn1_txt', __('Get Started', 'construct-ex'));
	$button_text2 = get_theme_mod('banner_btn2_txt', __('Know more', 'construct-ex'));
...
function construct_banner_video() {
