...
Construct is a beautiful business theme to get your web appearance.

== Description ==

Construct is a beautiful business theme that provides more customizing options to business people or freelancers to create a good website for Mobile app. Construct comes with some exciting features to create a awesome website. It has the customizing options like blog style, logo update, layout control, color modification, extra widgets, sticky menu and much more.
...
Icons
The icon set used in Construct is FontAwesome.
